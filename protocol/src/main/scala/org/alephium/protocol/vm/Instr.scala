...
sealed trait Transfer extends AssetInstr {
  ...
  private def addTransferInfo[C <: StatefulContext](
    ...
    Statistic.addTransferInfo(txId, this, lockupScript, tokenId, amount, timestamp)
  }
...
object Statistic {
  ...
  val transferInfos: mutable.ArrayBuffer[TransferInfo] = mutable.ArrayBuffer.empty
