...
class BlockSpec extends AlephiumSpec with NoIndexModelGenerators {
  ...
  trait TxExecutionOrderFixture {
    val (nonScriptTxIndexes, scriptTxIndexes) = Seq.from(0 until 20).partition(_ % 2 == 0)
